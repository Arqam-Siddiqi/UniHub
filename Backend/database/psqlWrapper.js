...
const mapSetup = async () => {
  ...
  await pool.query(`
    ...
    BEGIN
        ...
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (147,(SELECT id FROM segments WHERE floor_id=0 and direction='M'), 'Library', 'LH');

        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (148,(SELECT id FROM segments WHERE floor_id=1 and direction='M'), 'Auditorium', 'AR');
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (149,(SELECT id FROM segments WHERE floor_id=1 and direction='UR'), 'Conference Room', 'CR');


        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (150,(SELECT id FROM segments WHERE floor_id=1 and direction='LL'), 'Medical room', 'WR');
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (151,(SELECT id FROM segments WHERE floor_id=1 and direction='LL'), 'Male wash room', 'WR');
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (152,(SELECT id FROM segments WHERE floor_id=1 and direction='LL'), 'Female wash room', 'WR');


        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (153,(SELECT id FROM segments WHERE floor_id=2 and direction='M'), 'Cafeteria', 'Cafe');
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (154,(SELECT id FROM segments WHERE floor_id=2 and direction='LL'), 'Male wash room', 'WR');
        INSERT INTO Rooms  (id,segment_id, name, type) VALUES (155,(SELECT id FROM segments WHERE floor_id=2 and direction='LL'), 'Female wash room', 'WR');
